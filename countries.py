...
questions = ['В какой стране 17 век является «Бунташным»? Укажите название страны в именительном падеже.',
             'В какую страну направлялся Васко да Гама? Укажите название страны в именительном падеже.',
             'В какой стране в 16 веке был раскол из-за Мартина Лютера? Укажите название страны в именительном падеже.',
             'Страна, которая боролась за свою независимость в Нидерландской революции? Укажите название страны в именительном падеже.',
             'Страна, в которой в 16-17 веке правила Династия Тюдоров? Укажите название страны в именительном падеже.'
             ]
trueAnswers = ['Россия',
               'Индия',
               'Германия',
...
window = Tk()
window.title('Викторина по странам')
...
#pyinstaller --onefile countries.py